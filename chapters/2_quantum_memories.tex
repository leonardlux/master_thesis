...
\subsection{Syndromes Measurements and Error Subspaces}\label{ssec:syndrome}
...
\subsubsection{Cosets of Stabilizer Group - Logical Operators}
...
The exact circuit/approach of extracting the syndrome of a given state will be discussed in section \ref{chapter:syndrome_extraction}.
...
The error models used in this thesis are introduced in section \ref{chapter:error_models}.
...
For those we can identify a phase change in the model at the threshold probability, which we will discuss in section \ref{chapter:qec_thresholds}. 
...
We will go into more detail about this approach and what adaptions we need to make to adjust for the syndrome extraction process in section \ref{chapter:syndrome_extraction}. 
