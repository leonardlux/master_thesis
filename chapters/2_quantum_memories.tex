...
\end{equation}
Using one operator each from the stabilizer group $\mathcal{S}$, the set of realizations of the logical operators $\bar{\mathcal{P}}$ and the set of canonical representative errors associated with the syndromes, the associated operator is denoted by $E_\sigma$.
...
\begin{figure}[ht]
    ...
    \caption{
        TOOOOODOOOOOOo adapt text to new graphic!!
...
\begin{figure}[ht]
    ...
    \caption{
        TODOOOOOOO!
        \textcolor{red}{write propper text here!}
        Figure showing the configuration of the surface code. 
        A proper caption will follow when I redo this image properly. 
        I should change the logical X to the top row, to follow the definition used in my python code.}
