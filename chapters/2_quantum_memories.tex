...
% Should I here discuss more the Superoperators: Maarten commented this here in feedback 1
...
% done until here, including Maartens feedback ... at least most of it :Party:!
...
We will at this point assume\footnote{This is a valid assumption for the surface code, if we introduce boundary notes into our graph for errors connecting to the boundary \cite{topological_quantum_memory,pymatching_loger_paper}.} that we have such an error model.
...
\textcolor{green}{should i name the algorithm (this blossom one) that is used to find the minimum weight matching? or should i say that it can be found in the paper?}
...
% Should I make a connection here to the noncontractable loops of the toric code?


\begin{figure}[]
    \centering
    \includegraphics[width=0.8\linewidth]{graphics/surface_code_sketch.jpg}
    \caption{Figure showing the configuration of the surface code. A proper caption will follow when I redo this image properly. I should change the logical X to the top row, to follow the definition used in my python code.}
...
% Should I talk about syndrome extraction and state initialization 
