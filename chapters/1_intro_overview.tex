...
\begin{enumerate}
    ...
    % Error models
    \item The following chapter \ref{ssec:error_models} introduces the error models used in this thesis. 
    ...
    % syndrome extraction
    \item This is followed by chapter \ref{ssec:syndrome_extraction}, which introduces the syndrome extraction circuits analyzed in this thesis. 
    ...
    % threshold theorem
    \item The next chapter \ref{ssec:threshold_theorem} introduces the threshold and explains the process used to determine it based on Monte Carlo simulations of the circuit. 
